...
<div align="center">
<a href="README_INDEXTTS_2_ZH.md" style="font-size: 24px">简体中文</a> |
<a href="README_INDEXTTS_2.md" style="font-size: 24px">English</a>
</div>
...
PYTHONPATH="$PYTHONPATH:." uv run indextts/infer_v2_5.py \
  --cfg_path checkpoints_25/config.yaml \
  --model_dir checkpoints_25 \
  --text "Hello world" \
  --lang EN
```
...
tts = IndexTTS2(cfg_path="checkpoints_25/config.yaml", model_dir="checkpoints_25", use_bf16=True)
text = "Translate for me, what is a surprise!"
