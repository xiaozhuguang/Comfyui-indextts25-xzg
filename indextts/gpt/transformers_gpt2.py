...
# SequenceSummary was removed from newer transformers. It is only used by the
# unused GPT2DoubleHeadsModel; provide a minimal compatible implementation so
# the module still imports across transformers versions.
try:
