"""Build a TensorRT engine from the semantic codec encoder ONNX model.

Usage:
    python build_semantic_codec_trt.py [--onnx semantic_codec.onnx] [--output semantic_codec.engine]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Build TRT engine from semantic codec ONNX")
    parser.add_argument("--onnx", default="semantic_codec.onnx")
    parser.add_argument("--output", default="semantic_codec.engine")
