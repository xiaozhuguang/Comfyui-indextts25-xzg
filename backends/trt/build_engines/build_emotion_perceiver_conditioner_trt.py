"""Build a TensorRT engine from the emotion perceiver conditioner ONNX model.

Usage:
    python build_emotion_perceiver_conditioner_trt.py [--onnx emotion_perceiver_conditioner.onnx] [--output emotion_perceiver_conditioner.engine]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Build TRT engine from emotion perceiver conditioner ONNX")
    parser.add_argument("--onnx", default="emotion_perceiver_conditioner.onnx")
    parser.add_argument("--output", default="emotion_perceiver_conditioner.engine")
